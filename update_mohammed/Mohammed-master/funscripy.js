...
playerLeft.src = 'tl.png';
const playerRight = new Image();
playerRight.src = 'tp.png';
...
class Bubble {
    ...
    draw(){
        ...
        ctx.drawImage(bubble, this.x, this.y ,this.radius*2,this.radius*2 );
    }
}
...
/*bakgrouned*/
const bakgrouned =new Image();
bakgrouned.scr="map_c.png";
function handegrouned(){
    ctx.drawImage(bakgrouned,0,0,canvas.width,canvas.height)
